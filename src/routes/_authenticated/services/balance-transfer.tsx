...
export const Route = createFileRoute('/_authenticated/services/balance-transfer')({
...
function formatCurrencyInput(value: string): string {
  ...
  // Converte para number e divide por 100 para ter os centavos
  const amount = parseFloat(numbers) / 100

  // Formata com vírgula para separar decimais e ponto para milhares
...
function BalanceTransferPage() {
  ...
  const onSubmit = async (data: TransferFormData) => {
    ...
    // Reset after 3 seconds and hide success
    setTimeout(() => {
    ...
    <div className="space-y-6 max-w-3xl mx-auto">
      ...
      <div className="bg-gradient-to-r from-purple-600 to-pink-600 rounded-2xl p-6 sm:p-8 text-white shadow-lg">
        <div className="flex items-center gap-4 mb-3">
          ...
          <h1 className="text-2xl sm:text-3xl font-bold">Transferência de Saldo</h1>
        </div>
